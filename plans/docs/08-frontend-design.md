...
> Уточнення після голосового вводу: «голосовий ввід» переїхав із «Поза scope» до scope, і це навмисно вужче рішення, ніж звучить. У scope — **спосіб набору**: запис із мікрофона, один запит до власного ендпоінта, розпізнаний текст дописується в чернетку. Голос не стає окремим шляхом перекладу, не створює власного типу записів у History і нічого не додає до контракту `POST /translate/preview`: далі все відбувається так, ніби текст набрали руками. Поза scope лишається все інше, що зазвичай мають на увазі під голосом: диктування в реальному часі з проміжними гіпотезами, озвучення результату (TTS), голосові команди, розпізнавання мовця та зберігання аудіо. Сервером цієї функції є [04-api.md §7](04-api.md#7-voice-input-routes), приватністю — [06-security.md](06-security.md#voice-input).
