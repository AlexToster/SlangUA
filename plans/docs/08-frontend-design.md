...
- **плитка квадратна** (`aspect-ratio: 1 / 1`): ілюстрація лишається 4:3, а підпис займає смугу, що лишилась під нею, тому зазору між картинкою й назвою немає, паддінг однаковий з усіх боків, а міжрядковий інтервал підпису — 1,15. Квадрат не жорсткий: `min-height: min-content` дає плитці підрости на 4–9px на екранах 320–360px, де назва в два рядки не влазить у чверть ширини. Ілюстрація **без власного контуру** — обведена лише плитка, інакше на її краю читалася б подвійна рамка;
