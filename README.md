...
Я почав із ідеї AI-перекладача українських стилів і реалізував це у full-stack продукт. У процесі розібрався з архітектурою, API, БД, Redis, CI/CD та LLM abstraction, тестами. Цей проект - демонстрація того, як AI працює з українським контекстом — гумором, діалектами і соціальними особливостями мовлення.
...
> **Чесно про стан:** експериментую з Style Engine. Якість виводу залежить від обраної LLM — локальна
...
стиль має власний словник, промпт, приклади та «особистість персонажа», а стилі навмисно
