...
<img src="docs/assets/hero-styles.png" width="360" alt="Шість персонажів SlangUA за столиками кав'ярні" />

**Один текст - шість українських стилів.**

SlangUA - перекладач українських стилів на базі штучного інтелекту.
...
| **POFENI** — зеківський жаргон, 18+ | «Кіт підняв о шостій ранку з шконки і вимагав пайку» |
...
| 🖼 demo.gif: короткий приклад роботи |
| :------: |
...
Різниця між ними не лише в лексиці. **KANCLER** надмірно роздуває фрази у 2-4 рази. **POFENI** говорить крізь тюремну ієрархію і «поняття» — це інший регістр, ніж **STREET** (двір і вулиця), а **GALICIAN**
